  ...
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        <Link className={styles.link} to="/recursion" data-test="recursionLink" >
          <div className={`${styles.card} ${styles.string}`} />
        </Link>
        <Link className={styles.link} to="/fibonacci" data-test="fibonacciLink" >
          <div className={`${styles.card} ${styles.fibonacci}`} />
        </Link>
        <Link className={styles.link} to="/sorting" data-test="sortingLink" >
          <div className={`${styles.card} ${styles.arr}`} />
        </Link>
        <Link className={styles.link} to="/stack" data-test="stackLink" >
          <div className={`${styles.card} ${styles.stack}`} />
        </Link>
        <Link className={styles.link} to="/queue" data-test="queueLink" >
          <div className={`${styles.card} ${styles.queue}`} />
        </Link>
        <Link className={styles.link} to="/list" data-test="listLink" >
